                ...
                <div class="card-body">
                    <form method="post" action="admin/product" enctype="multipart/form-data">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <select required name="MaNhaCungCap" id="supplier_id" class="form-control">
                        ...
                        <!-- <div class="position-relative row form-group">
                            <label for="image" class="col-md-3 text-md-right col-form-label">Ảnh trang sức</label>
                            <div class="col-md-9 col-xl-8">
                                <input type="file" name="AnhTrangSuc" id="image" class="form-control-file">
                            </div>
                        </div> -->
