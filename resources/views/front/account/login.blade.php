...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../front/css/DangNhap.css" />
    <script type="text/javascript" src="myScript.js"></script>
    <script type="text/javascript" src="jquery-3.6.4.min.js"></script>
    <script type="text/javascript" src="../../front/DangNhap.js"></script>
...
<body>
    <div id="Dau_Trang_Web">
        <div id="container">
            ...
            <a style="width: 79px;height: 14px; text-align: left; margin-left: 10px;"><img src="../../front/HinhAnh/book.png">
                Trang sức đa dạng</a>
            <span style="text-align: left;">|</span>
            <a style="width: 82px;height: 14px; text-align: left; margin-left: 10px;"><img src="../../front/HinhAnh/smartphone-call.png">PNJ Store</a>
        </div>
    </div>
    <div id="top_panel">
        <div id="row1">
        ...
        <div id="body-content">
            <div id="login">
                <form action="" method="post">
                    ...
                    <input style="margin-left: 250px" type="checkbox" id="GhiNho" name="remember" value="1" />
                    <label style="float: right" for="GhiNho">Ghi nhớ thông tin</label>
                    <button id="btnlogin" type="submit" value="Đăng nhập">Đăng nhập</button>
                    <a href="#">
                        <p>Quên mật khẩu?</p>
                    </a>
