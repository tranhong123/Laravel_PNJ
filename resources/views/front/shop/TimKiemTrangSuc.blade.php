...
<div id="Dau_Trang_Web">
    ...
    <div id="wrapper_SachTheoDanhMuc">
        <div id="span14">
            <div id="breadcrumbs">
                <span><a href="" style="text-decoration: none; color: #000;">Trang chủ</a></span>
                <span>></span>
                <span><a href="" style="text-decoration: none;color: #000;">Tìm Kiếm</a></span>
            </div>
        </div>
        <div id="row">
            <div id="span3">
            ...
            <div id="span9">
                <div class="mainbox2_title">
                    <span id="mainbox2_title_span"></span>Trang Sức bạn muốn tìm<br>
                    <span>----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</span>
                </div>
                <div id="mainbox2_body">
                @foreach($trangsuc as $trangsuc)
    ...
    <div id="footer">
        <div id="tygh_footer">
            <div id="news_letter">
                ...
                <span>Đăng ký nhận thông tin về trang sức mói nhất</span></label>
                <div id="input_group">
